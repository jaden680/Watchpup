...
describe('ConfigStore', () => {
  it('applies defaults and persists updates', () => {
    ...
    s1.update({ mySlackUserId: 'U123', model: 'sonnet', petSizePercent: 150, bubbleSizePercent: 80, hudSizePercent: 70, hudAlignment: 'left', showActivityHud: false, naggingEnabled: true, naggingMinMinutes: 3, naggingMaxMinutes: 9, slackNewsEnabled: true, slackNewsChannels: ['all_random'], slackNewsKeywords: ['iOS'] })
